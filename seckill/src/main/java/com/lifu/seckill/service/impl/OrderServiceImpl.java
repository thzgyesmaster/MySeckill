...
public class OrderServiceImpl extends ServiceImpl<OrderMapper, Order> implements OrderService {
    ...
    public Order seckill(User user, GoodsVo goodsVo) {
        ...
        UpdateWrapper<SeckillGoods> queryWrapper1 = new UpdateWrapper<SeckillGoods>().setSql("stock_count = stock_count-1")
                .eq("goods_id" , goodsVo.getId()).gt("stock_count" , 0);

        boolean result = seckillGoodsService.update(queryWrapper1);
